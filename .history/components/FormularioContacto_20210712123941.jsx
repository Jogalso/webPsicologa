...
const FormularioContacto = () => {
    ...
    const onFieldError = React.useCallback(
        ...
        [addErrorNombre, addErrorEmail, addErrorPais, addErrorMotivo]
      );
    ...
    const onSubmit = (e) => {
        ...
        fetch('/api/send-email', {
          ...
          body: JSON.stringify({ nombre: valueNombre, email: valueEmail, pais: valuePais, motivo: valueMotivo })
        });
                    ...
                    <div className="formulario">
                        ...
                        >
                            <div className="titulo">
                                <span className="Titulo">Contact</span>
                            </div>                            
                            ...
                            <div className="containerMotivo">
                                <span className="spanMotivo">Reason</span>
                                <textarea
                                    name="motivo"
                                    type="text"
