...
function Header() {
  ...
  var handleScroll = function handleScroll(e) {
    ...
    if (element.scrollingElement.scrollTop < 200) {
      setArriba(true);
    } else {
      setArriba(false);
    }
